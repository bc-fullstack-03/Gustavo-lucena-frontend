...
function AuthForm(props: AuthFormProps) {
    ...
    function handleSubmit(event: FormEvent<AuthFormElement>) {
        ...
        const auth = {
            ...
            name: props.isRegister ? form.elements.name.value : undefined
        }
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4 items-stretch w-full max-w-sm mt-10">

                {
                    ...
                    <label className="flex flex-col gap-3 w-full" htmlFor="email">
                        <Text size='lg' className="font-base text-[#E1E1E6]"> Nome de Usuário </Text>
                        <TextInput.Root>
                            <TextInput.Icon>
                                <User />
                            </TextInput.Icon>

                            <TextInput.Input type="name" id='name' placeholder="Digite seu nome" />
                        </TextInput.Root>
                    </label>
                }
